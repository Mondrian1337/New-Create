...
BlockEvents.modification(e => {
	let Woods = [
		...
		"ecologics:flowering_azalea_log", "ecologics:flowering_azalea_wood", "ad_astra:glacian_log", "minecraft:crimson_stem",
		"minecraft:stripped_crimson_stem", "minecraft:crimson_hyphae", "minecraft:stripped_crimson_hyphae", "minecraft:warped_stem",
		"minecraft:stripped_warped_stem", "minecraft:warped_hyphae", "minecraft:stripped_warped_hyphae", "thermal:rubberwood_log",
		"thermal:rubberwood_wood", "thermal:stripped_rubberwood_log", "thermal:stripped_rubberwood_wood", "create_dd:rose_log",
		"create_dd:stripped_rose_log", "create_dd:rose_wood", "create_dd:stripped_rose_wood", "create_dd:smoked_log",
		"create_dd:stripped_smoked_log", "create_dd:smoked_wood", "create_dd:stripped_smoked_wood", "create_dd:spirit_log",
		"create_dd:stripped_spirit_log", "create_dd:spirit_wood", "create_dd:stripped_spirit_wood", "create_dd:rubber_log",
